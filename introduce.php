...
<![endif]-->
    ...
    <link rel="shortcut icon" href="http://demo.magikthemes.com/skin/frontend/base/default/favicon.ico"
        type="image/x-icon" />
    <title>E-Cormerce - Project - Giới thiệu</title>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9 col-xs-12 right_menu">
                            <div class="toplinks">
                                ...
                                <div class="welcome-msg hidden-xs">Xin chào !</div>
                                <!-- End Default Welcome Message -->
                                <div class="links">
                                    <div class="myaccount"><a title="My Account" href="
									"><span class="hidden-xs">My
                                                Account</span></a></div>
                ...
                <div class="row">
                    <div class="nav-inner col-lg-12">
                        <ul id="nav" class="hidden-xs">
                            ...
                            <li class="level0 parent drop-menu"><a href="#"><span>MANGO</span></a>
                             
                            </li>
                            <li class="level0 parent drop-menu"><a href="#"><span>ZARA</span></a>
                            
                            </li>

                            <li class="level0 active"><a href="introduce.php"><span>Giới thiệu</span></a></li>
        ...
        <section class="main-container col2-right-layout bounceInUp animated">
            <div class="main container">
                <div class="row" style="text-align:center">
                    <h1>ĐỒ ÁN NHÓM 7</h1>
                    <h3>Chủ Đề: Website Thương Mại Điện Tử Bán Quần Áo</h3>
                    <h3>Giảng Viên Hướng Dẫn: Thầy Th.S Võ Ngọc Tấn Phước</h3>
                    <h3>Mã Lớp Học Phần: CDCNTT20D GL 420300328102 - 020300304001</h3>
                    <br>
