...
<body class="cms-index-index cms-home-page">
  <div id="page">
        ...
        <div class="row">
          <div class="nav-inner col-lg-12">
            <ul id="nav" class="hidden-xs">
              <li class="level0 active parent drop-menu "><a href="index.php"><span>Home</span></a>
                <ul class="level1">
              ...
              <li class="mega-menu"><a href="introduce.php" class="level-top"><span>Giới thiệu</span></a></li>
    ...
    <div class="container-fluid">
      <img src='images/slide-img1.jpg' alt="slide-img" data-bgposition='left top' data-bgfit='cover'
      ...
      <div class="container">
        <ul class="bxslider">
          <li>
            ...
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut non libero magna. Sed et quam lacus. Fusce
              condimentum eleifend enim a feugiat. Pellentesque viverra vehicula sem ut volutpat. Integer sed arcu
              massa. </p>
