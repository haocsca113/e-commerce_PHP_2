    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="qlsp/"><i class="fa fa-circle-o"></i> Quản Lý Sản Phẩm</a></li>
            <li><a href="qlbaiviet/"><i class="fa fa-circle-o"></i> Quản Lý Bài Viết </a></li>
          </ul>
        </li>
        <!--*********** END Quản Lý SP & Bài Viết ***********-->
    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          ...
          <!--PRODUCT LIST 2 - SAN PHAM HET HANG-->
                  <!-- PRODUCT LIST -->
          <div class="box box-primary">
            <div class="box-header with-border">
      ...
      <!-- /.row -->
      <!----------------------------- END BOX HIỂN THỊ THÔNG TIN ĐƠN HÀNG  --------------------------------->
